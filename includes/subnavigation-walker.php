<?php
/**
 * Custom Walker - Sub navigation
 *
 * @since IESEG 1.0
 * @tutorial http://wordpress.stackexchange.com/questions/2802/display-a-portion-branch-of-the-menu-tree-using-wp-nav-menu/2809#2809
 */
...
class sub_nav_walker extends Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth, $args) {
		...
		//$class_names = ' class="' . esc_attr($class_names) . '"'; //ligne originale
        $class_names = ' class="' . esc_attr($class_names) . ' perso-menuid-'.$item->object_id.'"'; //ligne modifiée pour rajouter id de la page dans sous menu
